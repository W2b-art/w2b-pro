...
const TRANSLATIONS = {
  en: {
    ...
    hero_title_1:   "A visual representation",
    hero_title_2:   "of your values and project.",
    ...
    rates_editorial_EUR: "Editorial · half-day from €700",
    rates_editorial_COP: "Editorial · half-day from $1,100,000",
    rates_hospo_EUR:     "Hospitality · package from €900",
    ...
    bud_under_1k_EUR: "Under €1,000",
    bud_under_1k_COP: "Under $1,000,000",
    bud_1_3k_EUR:     "€1,000 – €3,000",
    bud_1_3k_COP:     "$1,000,000 – $3,000,000",
    bud_3_8k_EUR:     "€3,000 – €8,000",
    bud_3_8k_COP:     "$3,000,000 – $8,000,000",
    bud_8k_plus_EUR:  "€8,000+",
    bud_8k_plus_COP:  "$8,000,000+",
  ...
  fr: {
    ...
    hero_title_1:   "Une représentation visuelle",
    hero_title_2:   "de vos valeurs et de votre projet.",
    ...
    rates_editorial_EUR: "Éditorial · demi-journée à partir de 700 €",
    rates_editorial_COP: "Éditorial · demi-journée à partir de $1 100 000",
    rates_hospo_EUR:     "Hôtellerie-restauration · forfait à partir de 900 €",
    ...
    bud_under_1k_EUR: "Moins de 1 000 €",
    bud_under_1k_COP: "Moins de 1 000 000 $",
    bud_1_3k_EUR:     "1 000 € – 3 000 €",
    bud_1_3k_COP:     "1 000 000 $ – 3 000 000 $",
    bud_3_8k_EUR:     "3 000 € – 8 000 €",
    bud_3_8k_COP:     "3 000 000 $ – 8 000 000 $",
    bud_8k_plus_EUR:  "8 000 € et +",
    bud_8k_plus_COP:  "8 000 000 $ et +",
  ...
  es: {
    ...
    hero_title_1:   "Una representación visual",
    hero_title_2:   "de tus valores y tu proyecto.",
    ...
    rates_editorial_EUR: "Editorial · media jornada desde 700 €",
    rates_editorial_COP: "Editorial · media jornada desde $1.100.000",
    rates_hospo_EUR:     "Hostelería · paquete desde 900 €",
    ...
    bud_under_1k_EUR: "Menos de 1.000 €",
    bud_under_1k_COP: "Menos de $1.000.000",
    bud_1_3k_EUR:     "1.000 € – 3.000 €",
    bud_1_3k_COP:     "$1.000.000 – $3.000.000",
    bud_3_8k_EUR:     "3.000 € – 8.000 €",
    bud_3_8k_COP:     "$3.000.000 – $8.000.000",
    bud_8k_plus_EUR:  "Más de 8.000 €",
    bud_8k_plus_COP:  "Más de $8.000.000",
...
function applyPrices() {
  ...
  document.querySelectorAll('[data-price-option]').forEach(el => {
    const key = el.getAttribute('data-price-option') + '_' + currentCurrency;
